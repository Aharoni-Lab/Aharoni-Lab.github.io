function filter_list() {
	...
	items.forEach((e) => {
		...
		let in_categories = selected_categories.every(cat => {console.log(cat, item_categories); return item_categories.includes(cat)});
		// text matches search
		let content = e.textContent.toLowerCase();
		let matches_search = content.includes(search_query);
		console.log(e, selected_categories, in_categories, matches_search);
